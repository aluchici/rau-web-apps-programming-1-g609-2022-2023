...
class User:
    ...
    def __init__(self, id=None, first_name=None, last_name=None, email=None, password=None, second_password=None):
        self.id = id
    ...
    def from_dict(cls, user_dict):
        ...
        obj = cls(id=id, first_name=first_name, last_name=last_name, email=email, password=password,
